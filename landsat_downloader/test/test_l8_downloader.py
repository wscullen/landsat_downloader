...
class TestL8Downloader(unittest.TestCase):
    def setUp(self):
        ...
        self.test_footprint_2_result_list2 = [
            "12UWV",
            "12UWU",
            "12UWF",
            "12UWE",
        ...
        self.test_footprint_2_result_list_single = [
            "12UWV",
            "12UWU",
            "12UWF",
            "12UWE",
        ...
        self.path_to_intermediate_query_results_usgs_ee = Path(
            TEST_DIR, "test_data", "raw_results_query_by_tile_11UQR.json",
        )
        self.path_to_cleaned_query_results_usgs_ee = Path(
            TEST_DIR, "test_data", "clean_results_query_by_tile_11UQR.json",
        )
