...
class L8Downloader:
    ...
    def __init__(self, path_to_config, verbose=False):
    ...
    def authenticate(self):
        ...
        if os.path.isfile(auth_file):
            ...
            data = {
                    "username": self.config['USGS_USER'],
                    "password": self.config['USGS_PASS'],
                    "authType": "EROS",
                    "catalogId": "EE"
            }
    ...
    def populate_result_list(self, result, platform_name, dataset_name):
    ...
    def search_for_products_by_name(self, dataset_name, product_name_list, query_dict, just_entity_ids=False, write_to_csv=False):
        """
        ...
        if r.status_code == 200 and result['errorCode'] == None:
            ...
            result_list = self.populate_result_list(result, platform_name, dataset_name)
    ...
    def search_for_products(self, dataset_name, polygon, query_dict, just_entity_ids=False, write_to_csv=False):
        """
            example route /search
